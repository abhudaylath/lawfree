...
const features = [
    {
        ...
        description:
            "Receive instant legal guidance powered by AI, accessible anytime, anywhere.",
        additionalInfo: [
            "Save time with quick legal insights",
    ...
    {
        id: 2,
        title: "Instant Legal Document Generation",
        description:
            "Need a contract, NDA, or legal draft? Our AI generates them instantly. Just select your document type, and it's ready—saving you time and ensuring accuracy.",
        additionalInfo: [
            "AI-powered legal drafting",
            "Multiple document types",
            "Aligned with legal best practices",
        ],
        icons: [
            <svg
                key="click"
    ...
    {
        id: 3,
        title: "Effortless Editing & Secure Sharing",
        description:
            "Customize AI-generated legal documents with ease and share them securely. Edit, review, and export as a polished PDF—ready for legal use in seconds.",
        additionalInfo: [
            "User-friendly legal editing",
            "Secure PDF export",
                                        ...
                                        <span className="ml-auto">
                                            ...
                                            >
                                                <rect
                                                    ...
                                                    height="2"
                                                    rx="1"
                                                    className={`origin-center transform transition duration-200 ease-out ${activeFeature === feature.id ? "rotate-180" : ""
                                                        }`}
                                                />
                                                <rect
                                                    y="7"
                                                    ...
                                                    height="2"
                                                    rx="1"
                                                    className={`origin-center rotate-90 transform transition duration-200 ease-out ${activeFeature === feature.id
                                                            ? "hidden rotate-180"
                                                            : ""
                                                        }`}
                                                />
                        ...
                        <div className="">
                            {features.map((feature) => (
                                <Image
                                    ...
                                    decoding="async"
                                    data-nimg="1"
                                    className={`w-full rounded-[16px] border bg-slate-50 object-contain object-center transition-opacity duration-300 sm:-m-2 sm:w-[26rem] sm:p-2 ${activeFeature === feature.id
                                            ? "opacity-100"
                                            : "hidden opacity-0"
                                        }`}
