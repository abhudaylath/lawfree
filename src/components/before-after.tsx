                ...
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
                    <div className="rounded-2xl bg-white shadow-lg ring-2 ring-inset ring-slate-200">
                        <div className="p-8 sm:p-12">
                            ...
                            Legal processes that are slow, expensive, and complex
                            </h3>
                            <ul className="mt-6 space-y-3 text-base text-slate-600 sm:text-lg">
                                <li className="flex items-start gap-3">
                                    ...
                                    High legal fees make legal assistance inaccessible to many.
                                </li>
                                <li className="flex items-start gap-3">
                                    <div className="shrink-0 py-1.5">
                                        <svg
                                    ...
                                    Lengthy paperwork and bureaucratic delays slow down case resolutions.
                                </li>
                                <li className="flex items-start gap-3">
                                    <div className="shrink-0 py-1.5">
                                        <svg
                                    ...
                                    Difficulty in understanding legal jargon and navigating the system.
                                </li>
                                <li className="flex items-start gap-3">
                                    <div className="shrink-0 py-1.5">
                                        <svg
                                    ...
                                    Limited availability of lawyers, causing delays in legal consultations.
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div className="rounded-2xl bg-blue-500 shadow-lg ring-1 ring-inset ring-blue-400">
                        <div className="p-8 sm:p-12">
                            ...
                            An AI-driven legal assistant that simplifies legal processes
                            </h3>
                            <ul className="mt-6 space-y-3 text-base text-white sm:text-lg">
                                <li className="flex items-start gap-3">
                                    ...
                                    Affordable legal guidance, making justice accessible for everyone.
                                </li>
                                <li className="flex items-start gap-3">
                                    <div className="shrink-0 py-1.5">
                                        <svg
                                    ...
                                    Instant document generation and case analysis with AI.
                                </li>
                                <li className="flex items-start gap-3">
                                    <div className="shrink-0 py-1.5">
                                        <svg
                                    ...
                                    Easy-to-understand legal explanations in plain language.
                                </li>
                                <li className="flex items-start gap-3">
                                    <div className="shrink-0 py-1.5">
                                        <svg
                                    ...
                                    24/7 availability for quick legal support anytime, anywhere.
                                </li>
                            </ul>
                        </div>
                    </div>
